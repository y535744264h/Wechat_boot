...
public class UserRealm extends AuthorizingRealm {
    ...
    @Autowired
    private WxLabelService wxLabelService;
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection arg0) {
        WxUser user = ShiroUtils.getSysUser();
        // 角色列表
        ...
        //根据OpenID获取所在分组
        roles = wxLabelService.selectLabelNameByOpenId(user.getOpenid());

        menus = wxMenuService.selectPermsByOpenId(user.getOpenid());
